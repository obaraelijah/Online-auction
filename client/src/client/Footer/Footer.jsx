    ...
    <div className="row">
      ...
      <div className="col-lg-3 col-md-6 footer-contact">
        ...
        <p>
          Nairobi, Kenya<br/>
          Bestbid inc <br/><br/>
          <strong>Phone:</strong>+254 703229589<br/>
          <strong>Email:</strong> elijahobara357@gmail.com<br/>
        </p>
      </div>
      ...
      <div className="col-lg-3 col-md-6 footer-links">
        ...
        <div className="social-links mt-3">
          <a href="https://twitter.com/talkcoding" className="nav-link twitter"><FiTwitter/></a>
          <a href="https://www.linkedin.com/in/elijah-samson-16619912a/" className="nav-link twitter"><AiFillLinkedin/></a>

  ...
  <div className='row firstele'>
    <div className='col-10 mx-auto'>
      ...
      <h1> <strong className='brand-name'>Our Team</strong></h1>
        <h2 className="my-3">
        Team BestBid, comes up with a idea to provide a platform for the sellers who want to sell there product via bidding and want to get the best price. Our team verifies all the users. Team bestbid tries to make this platform 100% secure and safe. 
        </h2>
      </div>
